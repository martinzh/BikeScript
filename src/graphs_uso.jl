...
# distribucion de tiempos en todo el anio
for file in travs_files
    ...
    bins, counts = hist(dur_travs_filt, 51)
...
for file in travs_files
    ...
    bins, counts = hist(weekend_hr, 25)
